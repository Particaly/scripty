...
async function loadHistory() {
  ...
  loading.value = true
  const result = await window.scripty?.history?.list({ page: page.value, pageSize, search: search.value || undefined, status: status.value || undefined, trigger: trigger.value || undefined })
